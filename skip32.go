// skip32.go is a direct translation of skip32.c by Greg Rose:
//
...
/* Error type representing an encryption key that is too short.
 * Its value is the length of the key used.
 */
type ErrKeyTooShort int

func (e ErrKeyTooShort) Error() string {
	return fmt.Sprintf("key is not long enough: has %v, need %v",
		int(e), MIN_KEY_LEN)
}
